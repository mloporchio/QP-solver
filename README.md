...
where <img src="https://latex.codecogs.com/gif.latex?Q" title="Q" /> is a <img src="https://latex.codecogs.com/gif.latex?n \times n" title="n \times n" /> positive semidefinite matrix.
