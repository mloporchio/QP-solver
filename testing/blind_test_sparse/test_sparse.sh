...
#   on problems with sparse matrices.
#   The problems have variable size n, a variable number of constraints k
#   and a variable density d.
#

TEST_PATH="test_sparse"
SUFFIX="_c.dat"
SOLVER_PATH="./../qp-solver"
OUTFILE="test_sparse_alg.csv"
